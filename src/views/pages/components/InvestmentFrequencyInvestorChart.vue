...
export default {
    name: "InvestmentFrequencyInvestorChart",
    components: {
        QtRankingTable,
        QtRankingGraph
    },
...
<style
    ...
    lang="scss"
>
.investment-frequency-investor-chart::v-deep {
    display: flex;
    flex-wrap: wrap;
