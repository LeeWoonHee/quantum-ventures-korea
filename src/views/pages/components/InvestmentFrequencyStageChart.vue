<template>
    <div class="investment-frequency-stage-chart">
        <div
            class="left-investment-frequency-table"
            :style="radioValue === '산업' || radioValue === '투자자' ? 'width: 100%' : 'width: 28%'"
        >
            <!--   총 투자빈도수/투자단계 데이터 테이블       -->
            <qt-ranking-table
        ...
        <div
            class="right-investment-frequency-graph"
            v-if="radioValue === ''"
        >
            <!--   총 투자빈도수/투자단계 데이터 그래프       -->
            <qt-pie-chart
                :radioValue="radioValue"
                :companies="companies"
                :smallCategory="smallCategory"
...
import QtPieChart from "@/components/QtPieChart.vue"

export default {
    name: "InvestmentFrequencyStageChart",
    components: {
        QtRankingTable,
        QtPieChart
    },
...
<style
    ...
    lang="scss"
>
.investment-frequency-stage-chart::v-deep {
    display: flex;
    flex-wrap: wrap;
